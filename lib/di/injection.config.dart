...
import 'package:krypt/di/modules/app_module.dart' as _i10;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.singleton<_i8.FirebaseAuthenticationService>(
    ...
    gh.factory<_i9.SignUpScreenCubit>(
        () => _i9.SignUpScreenCubit(gh<_i8.FirebaseAuthenticationService>()));
    return this;
  }
}
